...
@section('textHero')
Educato l'ecole plus proche de vous!
@endsection
@section('boutontextHero')
    ...
    <div class="container">
        <div class="row justify-content-center mb-3">
            <div class="col-lg-7 text-center" data-aos="fade-up" data-aos-delay="0">
                <h2 class="line-bottom text-center mb-4">Domaines d'interventions</h2>
            </div>
        </div>
        ...
        <div class="row justify-content-between">
            <div class="col-lg-4 mb-5 mb-lg-0">
                ...
                <div class="section-title mb-3" data-aos="fade-up" data-aos-delay="0">
                    <h2 class="line-bottom mb-4">Connectez vous a vos enfants</h2>
                </div>
            ...
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="0">
                <figure class="img-wrap-2">
                    <img src="{{asset('frontend/images/teacher-min.jpg')}}" alt="Image" class="img-fluid">
